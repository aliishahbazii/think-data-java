...
public class MyTreeMap<K, V> implements Map<K, V> {
    ...
    private Node findNode(Object target) {
        ...
        return k.compareTo(root.key) > 0 ? root.right : k.compareTo(root.key) < 0 ? root.left : root;
    }
    ...
    private boolean containsValueHelper(Node node, Object target) {
        ...
        return equals(node.value, target) || equals(node.left.value, target) || equals(node.right.value, target);
    }
    ...
    private Set<K> addInOrder(Node node, Set<K> set) {
